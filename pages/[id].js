        ...
        <div className={styles.main_container}>
          <div>
            <div className={styles.anime_image_container}>
              <img
                ...
                src={
                  coverImage === null ? posterImage.large : coverImage.original
                }
                alt={canonicalTitle}
                width="640px"
                height="480px"
          ...
          <div className={styles.description}>
            ...
            <div className={styles.episode_details}>
              <p>
                <span className={styles.span}>Total episodes:</span>{" "}
                {episodeCount}
              </p>
              <p>
                <span className={styles.span}>Average episode length:</span>{" "}
                {episodeLength}mins
              </p>
              <p>
                <span className={styles.span}>Total length:</span> {totalLength}
                mins
              </p>
            </div>
            <p style={{ textAlign: "center" }}>
              <span className={styles.span}>
                Suitable for ages: {ageRatingGuide}
              </span>
            </p>
